...
public class JTExpressControllerAspect {
    ...
    public Object handleJTException(ProceedingJoinPoint jp) throws Throwable {
        ReturnResultVo retVal = null;
        try {
            retVal = (ReturnResultVo) jp.proceed();
            ...
            retVal = new ReturnResultVo(error, error.getMessage());
        }catch (JsonParseException jsonParseException)
        {
            logger.info("handleJTException: JTException， errno = {}",ReturnError.ILLEGAL_PARAMETER.getMessage());
            retVal = new ReturnResultVo(ReturnError.ILLEGAL_PARAMETER);
        }
            ...
            retVal = new ReturnResultVo(exception.getErrno(), exception.getMessage());
        } catch (Exception e) {
